...
git config --global user.name "pushpak5g"
git config --global user.email "pushapakgaikwad2000@gmail.com"

REM Clone github repository Change only repo link
git clone "https://github.com/pushpak5g/code-repository.git" "repository"
